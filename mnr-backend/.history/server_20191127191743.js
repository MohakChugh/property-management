...
app.post('/addproperty', async (req, res) => {
    ...
    if (validated === true) {
        ...
        let insertResult = await insert.addproperty(PropertyType,sellRent, price, partnerName, ownerName, locality, furnishedUnfurnished, floor, fhLh, ownerNumber, block, bhk, )
        .then((result) => {
            res.send(result);
        }).catch((err) => {
            console.log(err);
