...
app.post('/addproperty', async (req, res) => {
    ...
    if (validated === true) {
        ...
        // TODO: ADD Insert property code
        let insertResult = await insert.addproperty(PropertyType,sellRent, price, partnerName, ownerName, locality, furnishedUnfurnished, floor, fhLh, ownerNumber, block, bhk, area, address, propertyCategory, unitNumber, )
        .then((result) => {
            res.send(result);
        }).catch((err) => {
            console.log(err);
