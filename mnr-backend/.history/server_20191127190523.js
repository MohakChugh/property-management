...
app.post('/addproperty', async (req, res) => {
    ...
    if (validated === true) {
        // 
        let propertyCategory    = req.body.pro;
        let sellRent            = req.body.pro;
        let block               = req.body.pro;
        let bhk                 = req.body.pro;
        let floor               = req.body.pro;
        let furnishedUnfurnished= req.body.pro;
        let area                = req.body.pro;
        let price               = req.body.pro;
        let PropertyType        = req.body.pro;
        let address             = req.body.pro;
        let fhLh                = req.body.pro;
        let unitNumber          = req.body.pro;
        let locality            = req.body.pro;
        let description         = req.body.pro;
        let ownerName           = req.body.pro;
        let ownerNumber         = req.body.pro;
        let partnerName         = req.body.pro;
        // let additional_details = req.body.additional_details
        // 
        let insertResult = await insert.addclientData(name, email, phone, type, address, occupation, additional_details)
        // 
