...
app.post('/addproperty', async (req, res) => {
    ...
    if (validated === true) {
        ...
        let sellRent            = req.body.propertyCategory;
        let block               = req.body.propertyCategory;
        let bhk                 = req.body.propertyCategory;
        let floor               = req.body.propertyCategory;
        let furnishedUnfurnished= req.body.propertyCategory;
        let area                = req.body.propertyCategory;
        let price               = req.body.propertyCategory;
        let PropertyType        = req.body.propertyCategory;
        let address             = req.body.propertyCategory;
        let fhLh                = req.body.propertyCategory;
        let unitNumber          = req.body.propertyCategory;
        let locality            = req.body.propertyCategory;
        let description         = req.body.propertyCategory;
        let ownerName           = req.body.propertyCategory;
        let ownerNumber         = req.body.propertyCategory;
        let partnerName         = req.body.propertyCategory;
        // let additional_details = req.body.additional_details
        // 
        let insertResult = await insert.addclientData(name, email, phone, type, address, occupation, additional_details)
        // 
